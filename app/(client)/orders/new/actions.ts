...
function friendlySubmissionError(message: string): string {
  const safeMessages = [
    ...
    "Congratulations placements are incomplete",
    "Tournament dates are invalid",
    "Add between one and six players",
    "Player information is invalid",
    "Player references must be unique",
    "Player photo assignments are invalid",
